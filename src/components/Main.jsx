...
class Main extends React.Component {
  ...
  setActiveComponent(component) {
    ...
    console.log(`Mantra.setActiveComponent: activeComponent=${this.state.activeComponent}`);
  ...
  headerApps() {
    return (
      <>
        <label>Apps:</label>
        <button onClick={this.setActiveComponent.bind(this, 'vrgal-intro')}>vrgal</button>
      </>
    )
  }
  footer() {
    return(
      <footer class="main-footer">
        <button onClick={this.setActiveComponent.bind(this, 'vrgal-intro')}>vrgal-main</button>
        <button onClick={this.setActiveComponent.bind(this, 'mantra')}>mantra</button>
      </footer>
    )
  }
  ...
  render() {
    ...
    if (this.state.activeComponent === 'mantra') {
      return (
        <>
        {this.headerApps()}
        <Mantra parms={{setActiveComponent: this.setActiveComponent.bind(this)}}/>
